...
classes = ('cat', 'dog', 'pig', 'rabbit', 'parrot', 'snake', 'tiger', 'seal', 'panda', 'mouse', 'hamster', 'motocycle', 'car','sports_car', 'bicycle', 'phone', 'baby', 'Ultraman', 'skateboard', 'high_heels')
...
model = dict(
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            class_weights='/home/yechenzhi/.jupyter/B20/mmdetection/weights/c21.npy',
            bbox_coder=dict(
